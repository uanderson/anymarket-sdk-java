...
public enum Origin {
    ...
    ESTRANGEIRA_ADQUIRIDA_NO_MERCADO_INTERNO_SEM_SIMILAR(7),
    NACIONAL_IMPORTACAO_MAIS_70_PORCENTO(8); // Estrangeira - Adquirida no mercado interno, sem similar nacional, constante em lista da CAMEX
